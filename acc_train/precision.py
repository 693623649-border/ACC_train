...
def build_precision_plan(config: dict[str, Any]) -> PrecisionPlan:
    ...
    mixed_precision = _normal(precision_cfg.get("mixed_precision", training_cfg.get("mixed_precision")), "fp8").lower()
    fp8_backend = _normal(precision_cfg.get("fp8_backend"), "TE").upper()
    fp8_format = _normal(precision_cfg.get("fp8_format"), "HYBRID").upper()
